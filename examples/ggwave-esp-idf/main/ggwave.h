...
{
public:
    static constexpr auto kBaseSampleRate = 36000; //48000.0f;
    ...
    static constexpr auto kMaxSamplesPerFrame = 768; //2048;
    ...
    static constexpr auto kMaxRecordedFrames = 128; //2048;
